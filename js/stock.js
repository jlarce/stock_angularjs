...
.controller('StockController', function($scope) {
     $scope.products = [
        ...
        {code:'CP0002', description:'Tango 300', price:5, active:true, notes:'Very Old cell phone', picture: 'CP0002.jpg'},
        {code:'CP0003', description:'Nokia 1100', price:1000, active:true, notes:'Very Cool cell phone', picture: 'CP0003.jpg'},
